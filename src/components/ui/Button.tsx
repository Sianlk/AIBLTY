...
const styles = StyleSheet.create({
  ...
  // Variants
  variant_primary:   { backgroundColor: '#0EA5E9' },
  variant_secondary: { backgroundColor: '#38BDF833' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#0EA5E9' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#0284C7', borderWidth: 1, borderColor: '#38BDF8' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#0284C7' },
  label_outline:   { color: '#0EA5E9' },
  label_ghost:     { color: '#0EA5E9' },
