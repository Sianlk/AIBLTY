// Button Component — AIBLTY Health
...
const s = StyleSheet.create({
  ...
  v_primary:   { backgroundColor: '#0EA5E9' },
  v_secondary: { backgroundColor: '#38BDF833' },
  v_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#0EA5E9' },
  v_ghost:     { backgroundColor: 'transparent' },
  v_danger:    { backgroundColor: '#EF4444' },
  v_ai:        { backgroundColor: '#0284C7', borderWidth: 1, borderColor: '#38BDF8' },
  lbl:    { fontSize: 14, fontWeight: '600' },
  lv_primary:   { color: '#FFFFFF' },
  lv_secondary: { color: '#0284C7' },
  lv_outline:   { color: '#0EA5E9' },
  lv_ghost:     { color: '#0EA5E9' },
