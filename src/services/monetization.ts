// Monetization & Subscription Engine — AIBLTY Health
...
export const PLANS: Record<Plan, PlanConfig> = {
  ...
  starter: {
    ...
    price_monthly: 9.99,
    price_annual: 7.99,
    sku_monthly: 'com.sianlk.aiblty.starter.monthly',
    sku_annual: 'com.sianlk.aiblty.starter.annual',
    features: [
      '100 AI requests/day',
      'All health features',
  ...
  pro: {
    ...
    price_monthly: 29.99,
    price_annual: 19.99,
    sku_monthly: 'com.sianlk.aiblty.pro.monthly',
    sku_annual: 'com.sianlk.aiblty.pro.annual',
    features: [
  ...
  enterprise: {
    ...
    price_monthly: 99.99,
    price_annual: 79.99,
    sku_monthly: 'com.sianlk.aiblty.enterprise.monthly',
    sku_annual: 'com.sianlk.aiblty.enterprise.annual',
    features: [
