    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.tagline}>AI-Powered Healthcare at Your Fingertips</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Quick Access</Text>
        <View key="0" style={styles.featureCard}>
          <Text style={styles.featureText}>Telehealth Consultations</Text>
        </View>
        <View key="1" style={styles.featureCard}>
          <Text style={styles.featureText}>AI Health Insights</Text>
        </View>
