// AI Workforce Agent — AIBLTY Health
// Autonomous AI worker for health
...
// Specialised AI agents for health
const AGENT_PERSONAS = {
  analyst: {
    name: 'AIBLTY Health Analyst',
    role: `Expert health analyst with deep knowledge of medical diagnosis, wellness tracking, symptom analysis.`,
    capabilities: ["Health Monitoring", "AI Symptom Checker", "Medicine Tracker", "Telemedicine", "Health Records"],
  },
  advisor: {
    name: 'AIBLTY Health Advisor',
    role: `Senior health advisor providing strategic recommendations.`,
    capabilities: ['Strategic planning', 'Risk assessment', 'Optimization'],
  },
  automator: {
    name: 'AIBLTY Health Automator',
    role: `Autonomous health task executor and workflow manager.`,
