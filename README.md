...
<img src="assets/graphics/icon-1024.svg" width="120" alt="AIBLTY Health Icon" />

# AIBLTY Health

### AI-Powered Healthcare at Your Fingertips

[![CI](https://github.com/Sianlk/AIBLTY/actions/workflows/backend-ci.yml/badge.svg)](https://github.com/Sianlk/AIBLTY/actions/workflows/backend-ci.yml)
[![Security Scan](https://github.com/Sianlk/AIBLTY/actions/workflows/security-scan.yml/badge.svg)](https://github.com/Sianlk/AIBLTY/actions/workflows/security-scan.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-iOS%20|%20Android-lightgrey.svg)](https://aiblty.health)
...
[Website](https://aiblty.health) · [Privacy Policy](https://aiblty.health/privacy) · [Support](https://aiblty.health/support)
...
**AIBLTY Health** — AI-Powered Healthcare at Your Fingertips
...
- **AI-Powered Core** — Intelligent automation and recommendations tailored to healthcare
...
```bash
# Clone the repo
git clone https://github.com/Sianlk/AIBLTY.git
cd AIBLTY
