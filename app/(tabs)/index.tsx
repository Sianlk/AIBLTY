...
const ACTIONS = [
  { id: '1', title: 'Health Monitoring', icon: 'sparkles-outline' },
  { id: '2', title: 'AI Symptom Checker', icon: 'sparkles-outline' },
  { id: '3', title: 'Medicine Tracker', icon: 'sparkles-outline' },
  { id: '4', title: 'Telemedicine', icon: 'sparkles-outline' },
  { id: '5', title: 'Health Records', icon: 'sparkles-outline' },
];
