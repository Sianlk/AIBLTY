...
const QUICK_ACTIONS = [
        { id: '1', title: 'Health Monitoring', icon: 'sparkles-outline', color: Colors.primary },
        { id: '2', title: 'AI Symptom Checker', icon: 'sparkles-outline', color: Colors.primary },
        { id: '3', title: 'Medicine Tracker', icon: 'sparkles-outline', color: Colors.primary },
        { id: '4', title: 'Telemedicine', icon: 'sparkles-outline', color: Colors.primary },
        { id: '5', title: 'Health Records', icon: 'sparkles-outline', color: Colors.primary },
];
...
export default function HomeScreen() {
  ...
  async function handleAIQuery() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'health');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — health</Text>
        </View>
        <TextInput
          style={styles.aiInput}
          placeholder={`Ask AIBLTY Health AI anything...`}
