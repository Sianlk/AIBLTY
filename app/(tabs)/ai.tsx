...
// AIBLTY Health — AI Agents & Workforce
...
export default function AIScreen() {
  ...
  const [taskType, setTaskType] = useState('Health Monitoring');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Domain: health</Text>

      <Card variant="ai" style={styles.card}>
        <Text style={styles.label}>Task Type</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tagRow}>
          {['Health Monitoring','AI Symptom Checker','Medicine Tracker','Telemedicine','Health Records'].map((f) => (
            <TouchableOpacity
              key={f}
