...
function App(): React.JSX.Element {
  ...
  const onPress = () => {
    Animated.sequence([
      ...
      setReady(true);
      Alert.alert('AIBLTY', 'Welcome! App is running successfully.');
    });
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.hero}>
          ...
          <Text style={styles.title}>AIBLTY</Text>
          <Text style={styles.tagline}>The #1 AI-Powered Beauty & Aesthetics Platform</Text>
